...
from utils import load_config, load_jsonl, resolve, run_step, write_jsonl
...
def main() -> None:
    ...
    sys.path.insert(0, str(upload_dir / "workspace" / "stage0"))
    from run_stage0_policy_crop import process_one_case, load_router, pick_device
    from anatomy_expert import TotalSegLobeCache
