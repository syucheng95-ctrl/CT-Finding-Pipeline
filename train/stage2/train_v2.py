...
# V2: large patch enlarged to 224x224x48 for 97.2% coverage
GROUP_PATCH_SHAPES = {
    "small": (64, 64, 32),
    "medium": (96, 96, 48),
    "large": (224, 224, 48),
...
def main():
    ...
    parser.add_argument("--save-dir", type=Path, default=Path("outputs/stage2_multiscale_v2"))
    ...
    print("=" * 60)
    print("Multi-scale round-robin training V2 (random crop + stronger aug)")
