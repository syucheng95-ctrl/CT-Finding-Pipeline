...
class LungCache:
    def __init__(self):
        ...
        self.inferer = LMInferer(modelname="R231")
        self.cache = {}
...
def main():
    ...
    parser.add_argument("--manifest", default="../生医工大赛-demo/full_dataset_work/clean_full/manifest_all_stage2split_all.jsonl")
    parser.add_argument("--predictions", default="router_training/artifacts/reports/val_predictions.csv")
    parser.add_argument("--out-dir", default="router_training/artifacts/reports/stage0_policy_recall")
    ...
    for idx, (case_name, case_preds) in enumerate(by_case.items(), start=1):
        ...
        for p in case_preds:
            ...
            per_prompt_bboxes.append(policy_to_bbox(policy, lung_info, shape, zooms, margins))
        ...
        case_rows.append({
            ...
            "mapping_mode": lung_info.get("mapping_mode"),
            "lungmask_transform": lung_info.get("transform"),
            "auto_transform": lung_info.get("auto_transform"),
            "right_label": lung_info.get("right_label"),
            "left_label": lung_info.get("left_label"),
            "label_1_world_x": lung_info.get("label_1_world_x"),
            "label_2_world_x": lung_info.get("label_2_world_x"),
            "mapping_warning": lung_info.get("mapping_warning"),
        })
