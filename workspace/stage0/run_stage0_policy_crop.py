...
from anatomy_expert import TotalSegLobeCache, anatomy_record, anatomy_to_bbox, parse_anatomy
...
def process_one_case(args_dict: dict, model_bundle: dict | None = None):
    ...
    if model_bundle and all(k in model_bundle for k in ("tokenizer", "embedder", "head", "head_cfg")):
